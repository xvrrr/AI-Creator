...
class Voice_Maker:
    def __init__(self):
        ...
        # Navigate to the root directory (two levels up from agents)
    ...
    def initialize_model(self):
        ...
        prompt_speech_path = os.path.join(self.voice_data_dir, 'mike_prompt_16k.wav')
    ...
    def generate_voice(self):
        ...
        try:
            ...
            output_audio_path = os.path.join(self.voice_gen_dir, 'gen_audio.wav')
...
def voice_main():
    ...
    if isinstance(result, bool):
        ...
        if result:
            return {
                "audio_file": os.path.join(voice_maker.voice_gen_dir, 'gen_audio.wav'),
                "timestamp_file": os.path.join(voice_maker.voice_gen_dir, 'gen_audio_timestamps.json'),
                "status": "success"
            }
        else:
            return {
